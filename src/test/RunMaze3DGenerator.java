...
public class RunMaze3DGenerator {
    ...
    private static void testMazeGenerator(IMaze3DGenerator maze3DGenerator) {
        ...
        Maze3D maze = maze3DGenerator.generate(3, 10/*rows*/, 10/*columns*/); // prints the maze
        maze.print();
        ...
        System.out.println(String.format("Maze generation time(ms): %s", maze3DGenerator.measureAlgorithmTimeMillis(3, 100/*rows*/,100/*columns*/)));
    }
}
